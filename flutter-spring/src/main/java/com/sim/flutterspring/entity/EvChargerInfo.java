...
public class EvChargerInfo {
    ...
    @Builder
    public EvChargerInfo(String statNm, String statId, Long chgerId, Long chgerType, String addr, String location,
                         String useTime, Double lat, Double lng, String busiId, String bnm, String busiNm, String busiCall,
                         Long chstat, Date statUpdDt, Date lastTsdt, Date lastTedt, Date nowTsdt, String powerType,
                         Long output, String method, Long zcode, Long zscode, String kind, String kindDetail,
                         boolean parkingFree, String note, boolean limitYn, String limitDetail, boolean delYn,
                         String delDetail, boolean trafficYn) {
        this.statNm = statNm;
        this.statId = statId;
